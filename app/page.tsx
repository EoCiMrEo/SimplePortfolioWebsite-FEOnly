  ...
  return (
    <main className="relative bg-black-100 flex justify-center items-center flex-col mx-auto sm:px-10 px-5 overflow-clip">
      <div className="fixed top-4 left-4 z-[9999] group cursor-pointer p-2">
        ...
        >
          <h1 className=" text-white font-bold text-sm md:text-base lg:text-lg hover:text-purple-400 transition-all duration-300 transform hover:drop-shadow-lg text-center whitespace-nowrap hidden lg:block">
            Edward Phuong
          </h1>
        </a>
      </div>
